...
function ZoneWiseKahrakmaf() {
  ...
  const ZONE_1=useAPi(Base_Url+"vtlzone1/200")
        ...
        <div className="zone1-wise-area">
          ...
          <span className="data1-point6">{allValues.tag5} Kg/Cm2</span>
            ...
            <div className="zonewise1-btn-group">
                <Link to="/second"><button>Instantaneous</button> </Link> 
              <Link ><button  onClick={handleClick}>Logbook </button></Link>
              <Link to="/pratitnagar"><button>Zonewise pressure of Kangari</button></Link>
              <Link to="/nathuawala"><button>Zonewise pressure of Matranchal</button></Link>
              <Link to="/nathuawala"><button>Zonewise pressure of Achiver Home</button></Link>
            </div>
